...
public class ExperimentalFlywheel implements Subsystem
{
    public static final ExperimentalFlywheel INSTANCE = new ExperimentalFlywheel();
    private ExperimentalFlywheel() { }
